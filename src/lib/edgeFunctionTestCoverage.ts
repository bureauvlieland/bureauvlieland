...
const REGISTRY: Row[] = [
  ...
  { name: "secrets-export", category: "utility", critical: false }, // tijdelijk, verhuizing (docs/migratie-supabase.md)
  ...
  { name: "map-sync-blocks", category: "utility", critical: false },
  ...
  { name: "cron-watchdog", category: "internal", critical: true },
