                  ...
                  >
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 text-xs text-muted-foreground">
                        ...
                        <span>•</span>
                        <span>€{Number(invoice.amount_incl_vat ?? (Number(invoice.amount_excl_vat || 0) + Number(invoice.vat_amount || 0))).toLocaleString("nl-NL", { minimumFractionDigits: 2, maximumFractionDigits: 2 })} incl.</span>
                        {invoice.description && (
                          <>
                            <span>•</span>
