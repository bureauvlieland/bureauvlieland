...
const ACTION_LABELS: Record<string, { label: string; icon: React.ReactNode }> = {
  ...
  guest_details_updated: { label: "Gastenlijst/dieetwensen bijgewerkt", icon: <User className="h-3 w-3" /> },
  accommodation_setup_updated: { label: "Kamers/verzorging gewijzigd", icon: <BedDouble className="h-3 w-3" /> },
  notes_changed: { label: "Opmerking bij activiteit gewijzigd", icon: <MessageSquare className="h-3 w-3" /> },
