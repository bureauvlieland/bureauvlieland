...
export const Terms = () => {
  return (
    <div className="min-h-screen">
      <Navigation />
      <main id="main-content" className="py-16 sm:py-20 lg:py-24 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            ...
            <section>
              ...
              <p className="text-foreground mb-2">5.3. De arrangementsprijs is gebaseerd op de geldende prijzen, wisselkoersen, en belastingtarieven, zoals deze bij Bureau Vlieland bekend waren bij het uitbrengen van de offerte. Alle prijzen worden standaard exclusief BTW getoond. De verschuldigde BTW wordt apart gespecificeerd op de offerte en factuur.</p>
