-- Update the trigger function to check if linked_program_id already exists
...
BEGIN
  -- If linked_program_id is already set, skip creating a new program
  -- This allows linking to an existing program from the customer portal
