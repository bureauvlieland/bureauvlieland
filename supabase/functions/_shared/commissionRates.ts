/**
 * Eén bron voor commissiepercentages per partner.
 *
 * Staat in `_shared` zodat de admin-UI, de reconciliatie en de edge functions
 * gegarandeerd hetzelfde percentage hanteren. Eerder stonden er losse terugvallen
 * van 10 % en 15 % verspreid door de code, waardoor de pro forma aan de partner
 * een ander bedrag noemde dan de werklijst van het bureau.
