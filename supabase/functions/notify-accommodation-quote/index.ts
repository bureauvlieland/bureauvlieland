      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="background: linear-gradient(135deg, #f0fdf4 0%, #ecfdf5 100%); padding: 24px; border-radius: 12px; margin: 20px 0; border: 1px solid #86efac;">
          ...
          <div style="background: white; padding: 16px; border-radius: 8px; margin-bottom: 16px;">
            <table style="width: 100%; border-collapse: collapse;">
              <tr>
                ...
                <td style="padding: 8px 0; text-align: right;"><strong>${formatDate(request.arrival_date)}</strong></td>
              </tr>
              <tr>
                <td style="padding: 8px 0; color: #666;">Vertrek:</td>
                <td style="padding: 8px 0; text-align: right;"><strong>${formatDate(request.departure_date)}</strong></td>
              </tr>
              <tr>
          ...
          <div style="background: #166534; color: white; padding: 16px; border-radius: 8px; text-align: center;">
            ...
            <p style="margin: 8px 0 0; font-size: 28px; font-weight: bold;">${formatCurrency(quote.price_total)}</p>
            ${quote.price_per_person_per_night ? `
            <p style="margin: 4px 0 0; font-size: 12px; opacity: 0.9;">
              (${formatCurrency(quote.price_per_person_per_night)} p.p.p.n.)
            </p>
            ` : ""}
          </div>
    ...
    await sendEmailViaMailjet([
      {
        ...
        Subject: `Nieuwe offerte ontvangen: ${quote.accommodation_name}`,
