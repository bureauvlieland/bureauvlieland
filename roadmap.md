...
- [ ] Visitvlieland.nl omzetten naar de nieuwe database (leest logies- en activiteitenvermeldingen nog uit de oude, zie `docs/migratie-supabase.md`); moet vóór het opruimen van Lovable Cloud
