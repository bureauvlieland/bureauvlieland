...
- **Edge function tests** — `deno test --reporter=junit` over `supabase/functions/` (bewust niet parallel: de modules delen de omgevingsvariabelen); totalen + failure-excerpts in de summary.
